...
from menu.pantallas_menu import PantallaPrincipal, PantallaInputNombre, PantallaRecords, PantallaPromptRecord, PantallaConfiguracion
    ...
    def __init__(self, pantalla):
        ...
        try:
            if ruta_fondo:
                ...
                if self.fondo.get_size() != pantalla.get_size():
                    self.fondo = pygame.transform.smoothscale(self.fondo, pantalla.get_size())
        except Exception:
